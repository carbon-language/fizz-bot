...
* If want to stop hearing about your own PRs waiting for update, you can use `/fizz my_update_pings_are False`. \n\
...
* If you want to regenerate your current alerts immediately instead of waiting for the next timer, you can request it with `/fizz wake`. \n\
* And you can make me forget everything about you with `/fizz remove_me`. \n\
\n\
I can't start alerting about GitHub PRs until I know which repository to watch, and where to send messages. \n\
